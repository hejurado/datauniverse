...
Si llamamos $X$ a la variable y $x_i$ los valores que puede tomar la variable, la media aritmética se nota por $\bar{x}$ y se define por

$$\bar{x}=\sum_{i=1}^kf_{i}x_{i}=\frac{1}{n}\sum_{i=1}^kn_{i}x_{i}$$
:::
